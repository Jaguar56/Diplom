...
export default function Sidebar() {
  ...
  const loadConversations = () => {
    ...
    const query = getConversationQueryByUser(auth.id);
    ...
    <div className="sidebar">
      ...
      <div className="wrapper">
        <div className="top">
          ...
          {newChat && <span className="heading">Добавить пользователя</span>}
          <div
          ...
          <div className="search-wrapper">
            <div className="input-wrapper">
              ...
              <input
                ...
                type="text"
                placeholder={newChat ? "Поиск контактов" : "Поиск пользователя"}
              />
            </div>
          </div>
